...
def main():
    ...
    orig_p = st.sidebar.number_input("Source Port", min_value=0, max_value=27309, value=10000, step=1)
    resp_h = st.sidebar.number_input("Destination IP", min_value=0, max_value=172516, value=20, step=1)
    resp_p = st.sidebar.number_input("Destination Port", min_value=0, max_value=48065, value=80, step=1)
